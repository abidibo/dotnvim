return {
    {
        ...
        config = function()
            ...
            lsp_zero.on_attach(function(client, bufnr)
                ...
                vim.keymap.set("n", "gi", function() vim.lsp.buf.implementation() end, { buffer = bufnr, remap = false })
                ...
                vim.keymap.set("n", "<leader>crn", function() vim.lsp.buf.rename() end, { buffer = bufnr, remap = false, desc='Rename' })
                -- vim.keymap.set("i", "<c-h>", function() vim.lsp.buf.signature_help() end, { buffer = bufnr, remap = false })
                vim.keymap.set("n", "<leader>cf", function() vim.lsp.buf.format() end, { buffer = bufnr, remap = false, desc='Code format' })
            end)
